...
public class main_view {
	...
	private void initialize() {
		...
		JButton btnNewButton = new JButton("+ Ny Fr�ga");
		...
		JLabel lblAntalFrgor = new JLabel("Antal Fr�gor: ");
		...
		JLabel lblFrga = new JLabel("Fr�ga ");
		...
		JButton returnbutton = new JButton("<- �terg�");
	...
	private void checkAnswer() {
		...
		if(answerArr[qnumber-2].equals(answerField.getText())) {
			...
			answerFeedbackLabel.setText("R�tt!");
